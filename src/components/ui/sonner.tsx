...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "group toast group-[.toaster]:bg-background group-[.toaster]:text-foreground group-[.toaster]:border-border group-[.toaster]:shadow-lg group-[.toaster]:text-base group-[.toaster]:py-4 group-[.toaster]:px-5 group-[.toaster]:min-w-[320px]",
          ...
          warning: "group-[.toaster]:bg-orange-50 group-[.toaster]:text-orange-900 group-[.toaster]:border-orange-200 dark:group-[.toaster]:bg-orange-950 dark:group-[.toaster]:text-orange-100 dark:group-[.toaster]:border-orange-800",
