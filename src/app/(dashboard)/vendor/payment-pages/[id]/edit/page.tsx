              ...
              <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div className="border rounded-lg p-4 bg-gray-50">
                  ...
                  <p className="text-xs text-gray-500 mb-4">
                    ...
                    {paymentPage?.platform_fee_percentage && Number(paymentPage.platform_fee_percentage) > 0 && (
                      <span className="ml-1 font-medium text-blue-600">
                        (Platform fee: {paymentPage.platform_fee_percentage}%)
                      </span>
                    )}
                  </p>
                  <div className="space-y-3">
                    <label className={`flex items-start gap-3 p-3 border-2 rounded-lg bg-white cursor-pointer transition-colors ${!formValues.include_fees_in_amount ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-blue-300'}`}>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Customer pays the exact amount. Fee is deducted from your earnings.
                        </p>
                      </div>
                    </label>
