            ...
            <TabsContent value="basic">
              <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div className="border rounded-lg p-4 bg-gray-50">
                  ...
                  {formValues.fixed_amount && formValues.fixed_amount > 0 && organizationCountry?.platform_fee_percentage && Number(organizationCountry.platform_fee_percentage) > 0 && (
                    <div className="mt-4 p-4 bg-white border border-gray-200 rounded-lg">
                      ...
                      {formValues.fee_mode === 'excluded' ? (
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Platform fee ({organizationCountry.platform_fee_percentage}%):</span>
                            <span className="text-red-600">- {formValues.currency_code} {(formValues.fixed_amount * Number(organizationCountry.platform_fee_percentage) / 100).toFixed(2)}</span>
                          </div>
                          <div className="border-t pt-2 mt-2">
                            ...
                            <div className="flex justify-between text-sm mt-1">
                              ...
                              <span className="font-bold text-blue-600">{formValues.currency_code} {(formValues.fixed_amount * (1 - Number(organizationCountry.platform_fee_percentage) / 100)).toFixed(2)}</span>
                            </div>
                          </div>
                        </div>
                      ) : (
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Platform fee ({organizationCountry.platform_fee_percentage}%):</span>
                            <span className="text-gray-500">+ {formValues.currency_code} {(formValues.fixed_amount * Number(organizationCountry.platform_fee_percentage) / 100).toFixed(2)}</span>
                          </div>
                          <div className="border-t pt-2 mt-2">
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-700 font-medium">Customer pays:</span>
                              <span className="font-bold text-gray-900">{formValues.currency_code} {(formValues.fixed_amount * (1 + Number(organizationCountry.platform_fee_percentage) / 100)).toFixed(2)}</span>
                            </div>
                            <div className="flex justify-between text-sm mt-1">
                              <span className="text-gray-700 font-medium">You receive:</span>
