...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await laravelClient.post<{ data: unknown }>('/notifications/preferences/bulk', body);
    ...
    console.error('[/api/notifications/preferences/bulk] POST Error:', apiError.response?.data?.message || 'Unknown error');
