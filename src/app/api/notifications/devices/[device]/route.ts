...
/**
 * DELETE /api/notifications/devices/[device]
 * Remove a device
 */
export async function DELETE(
  ...
  try {
    ...
    await laravelClient.delete(`/notifications/devices/${device}`);
    ...
    console.error('[/api/notifications/devices/[device]] DELETE Error:', apiError.response?.data?.message || 'Unknown error');
