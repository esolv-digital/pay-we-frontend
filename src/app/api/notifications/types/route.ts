...
export async function GET() {
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>('/notifications/types');
    ...
    console.error('[/api/notifications/types] GET Error:', apiError.response?.data?.message || 'Unknown error');
