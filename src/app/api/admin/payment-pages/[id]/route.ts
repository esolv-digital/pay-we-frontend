...
/**
 * GET /api/admin/payment-pages/[id]
 * Get a single payment page
 */
export async function GET(
  ...
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>(`/admin/payment-pages/${id}`);
    ...
    console.error('[/api/admin/payment-pages/[id]] GET Error:', apiError.response?.data?.message || 'Unknown error');
