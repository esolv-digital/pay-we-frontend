...
/**
 * GET /api/admin/vendors/statistics
...
export async function GET() {
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>('/admin/vendors/statistics');
    ...
    console.error('[/api/admin/vendors/statistics] GET Error:', apiError.response?.data?.message || 'Unknown error');
