...
export async function POST(
  ...
  try {
    ...
    const response = await laravelClient.post<{ data: unknown }>(`/admin/vendors/${id}/suspend`, body);
    ...
    console.error('[/api/admin/vendors/[id]/suspend] POST Error:', apiError.response?.data?.message || 'Unknown error');
