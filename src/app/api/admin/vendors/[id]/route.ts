...
export async function GET(
  ...
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>(`/admin/vendors/${id}`);
    ...
    console.error('[/api/admin/vendors/[id]] GET Error:', apiError.response?.data?.message || 'Unknown error');
