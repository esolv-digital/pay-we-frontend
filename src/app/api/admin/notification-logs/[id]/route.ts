...
export async function GET(
  ...
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>(`/admin/notification-logs/${id}`);
    ...
    console.error('[/api/admin/notification-logs/[id]] GET Error:', apiError.response?.data?.message || 'Unknown error');
