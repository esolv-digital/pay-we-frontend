...
/**
 * POST /api/admin/payout-accounts/[id]/verify
...
export async function POST(
  ...
  try {
    ...
    const response = await laravelClient.post<{ data: unknown }>(`/admin/payout-accounts/${id}/verify`);
    ...
    console.error('[/api/admin/payout-accounts/[id]/verify] POST Error:', apiError.response?.data?.message || 'Unknown error');
    ...
    return NextResponse.json(
      {
        error: 'Failed to verify payout account',
