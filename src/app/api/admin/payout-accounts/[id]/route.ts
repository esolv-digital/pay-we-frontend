...
export async function GET(
  ...
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>(`/admin/payout-accounts/${id}`);
    ...
    console.error('[/api/admin/payout-accounts/[id]] GET Error:', apiError.response?.data?.message || 'Unknown error');
