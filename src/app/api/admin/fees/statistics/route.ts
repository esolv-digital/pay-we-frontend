...
export async function GET() {
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>('/admin/fees/statistics');
    ...
    console.error('[/api/admin/fees/statistics] GET Error:', apiError.response?.data?.message || 'Unknown error');
