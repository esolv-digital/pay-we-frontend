...
/**
 * GET /api/admin/messaging-providers/statistics
...
export async function GET() {
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>('/admin/messaging-providers/statistics');
    ...
    console.error('[/api/admin/messaging-providers/statistics] GET Error:', apiError.response?.data?.message || 'Unknown error');
