...
export async function POST(
  ...
  try {
    ...
    const response = await laravelClient.post<{ data: unknown }>(`/admin/disbursements/${id}/reject`, body);
    ...
    console.error('[/api/admin/disbursements/[id]/reject] POST Error:', apiError.response?.data?.message || 'Unknown error');
    ...
    return NextResponse.json(
      {
        error: 'Failed to reject disbursement',
