...
/**
 * GET /api/admin/countries/statistics
...
export async function GET() {
  try {
    ...
    const response = await laravelClient.get<{ data: unknown }>('/admin/countries/statistics');
    ...
    console.error('[/api/admin/countries/statistics] GET Error:', apiError.response?.data?.message || 'Unknown error');
