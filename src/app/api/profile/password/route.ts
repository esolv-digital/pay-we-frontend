...
export async function PUT(request: NextRequest) {
  try {
    ...
    const response = await laravelClient.put<{ message: string }>('/profile/password', body);
    ...
    console.error('[/api/profile/password] PUT Error:', apiError.response?.data?.message || 'Unknown error');
