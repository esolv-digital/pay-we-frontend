...
export async function PUT(request: NextRequest) {
  try {
    ...
    const response = await laravelClient.put<{ email: string }>('/profile/email', body);
    ...
    console.error('[/api/profile/email] PUT Error:', apiError.response?.data?.message || 'Unknown error');
